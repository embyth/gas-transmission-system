...
5. [Алгоритм розрахунку](#алгоритм-розрахунку)
  1. [Розрахунок фізичних властивостей природного газу](#розрахунок-фізичних-властивостей-природного-газу)
  2. [Розрахунок наявної потужності газотурбінного приводу ГПА компресорної станції](#розрахунок-наявної-потужності-газотурбінного-приводу-гпа-компресорної-станції)
  3. [Розробка математичних моделей нагнітача](#розробка-математичних-моделей-нагнітача)
  4. [Розрахунок режиму роботи нагнітача з використанням математичних моделей](#розрахунок-режиму-роботи-нагнітача-з-використанням-математичних-моделей)
  5. [Розрахунок витрат газу на власні потреби компресорної станції](#розрахунок-витрат-газу-на-власні-потреби-компресорної-станції)
  6. [Теплогідравлічний розрахунок ділянки газопроводу](#теплогідравлічний-розрахунок-ділянки-газопроводу)
...
<table>
  <tr align="center">
    <td>Компонент</td>
    <td>Молярна маса, кг/кмоль</td>
    <td>Критичний тиск, МПа</td>
    <td>Критична температура, К</td>
    <td>Нижча теплота згорання, кДж/м<sup>3</sup></td>
  </tr>
  <tr align="center">
...
<p>
  де <code>η<sup>м</sup></code> – механічний ККД нагнітача (<a href="#технічні-параметри-газотурбінних-гпа">див. таблицю</a>).<br>
</p>
...
<p>
  де <code>Q<sub>пг</sub></code> – сумарна витрата паливного газу по компресорному цеху (КЦ) для робочих ГПА, млн.м<sup>3</sup>/д;
...
<p>
  де <code>q<sub>пг</sub><sup>н</sup></code> – номінальна витрата паливного газу з урахуванням поправки на допуски та технічний стан ГТУ, числове значення наведене у <a href="#технічні-параметри-газотурбінних-гпа">таблиці</a>, тис.м<sup>3</sup>/год;
  <code>Q<sub>нр</sub><sup>н</sup></code> – номінальне значення нижчої теплоти згорання природного газу, прийняте в теплотехнічних розрахунках, <code>Q<sub>нр</sub><sup>н</sup> = 34500 кДж/м<sup>3</sup></code>.
</p>
...
<p>
  де <code>Н<sub>тп</sub></code> – середня питома витрата газу на технологічні потреби КС та лінійної ділянки газопроводу, м<sup>3</sup>/(кВт·год);
  <code>N<sub>кц</sub></code> – кількість ГПА встановлених в компресорному цеху.
</p>
...
<p>
  ...
  <code>z<sub>ср</sub></code>Zср – середнє значення коефіцієнта стисливості газу;<br>
...
<p>
  та повторюємо розрахунки, починаючи з формули 48.<br>
</p>
