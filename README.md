...
<p>
  <code>k<sub>o</sub></code> - коефіцієнт одночасності, значення якого залежать від асортименту газових приладів та кількості квартир, приймається згідно з додатком Д ДБН В.2.5-20 (<a href="#коефіцієнт-одночасності-залежно-від-асортименту-встановлених-у-квартирі-газових-приладів">див. таблицю</a>),<br>
